...
pygame.display.set_caption("Adding health stats") # set caption for the screen
...
bg_img = pygame.image.load("SharpShooter/images/bg_img.jpeg") # since it is relative path (the image is present in our project directory)
bg_img = pygame.transform.scale(bg_img, (w_width, w_height))
# soldier
walkRight = [pygame.image.load(f'SharpShooter/soldier/{i}.png') for i in range(1,10)]
walkLeft = [pygame.image.load(f'SharpShooter/soldier/L{i}.png') for i in range(1,10)]
char = pygame.image.load('SharpShooter/soldier/standing.png')
# enemy
moveLeft = [pygame.image.load(f'SharpShooter/enemy/L{i}.png') for i in range(1,10)]
moveRight = [pygame.image.load(f'SharpShooter/enemy/R{i}.png') for i in range(1,10)]
# text
