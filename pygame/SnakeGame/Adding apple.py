...
snake_x = round((window_width/2)/20)*20 # initail cordinates of snake 
snake_y = round((window_height/2)/20)*20 # after div by 20 and round and mult by 20 makes it allign with the game grid 
