...
# sound
laser = pygame.mixer.Sound("Spaceship/media/laser.wav")
explosion = pygame.mixer.Sound("Spaceship/media/explosion.wav")
explosion2 = pygame.mixer.Sound("Spaceship/media/explosion2.wav")
...
alien_bullets = []
score = 0
font1 = pygame.font.SysFont("helvatica", 30, 1, 1)
